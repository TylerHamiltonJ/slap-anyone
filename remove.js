function polygonCrop(image, canvas) {
  return new Promise((resolve, reject) => {
    ...
    ctx.strokeStyle = "rgb(187, 134, 252)";
    ...
    function start() {
      ...
      cw = canvas.width = imageAspectRatio.width;
      ch = canvas.height = imageAspectRatio.height;

      // draw the image at 25% opacity
      drawItemToCanvas(0.5);
    ...
    function drawItemToCanvas(alpha) {
